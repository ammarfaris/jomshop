...
function RadioGroupItem({
  ...
  return (
    <RadioGroupPrimitive.Item
      className={cn(
        'border-input dark:border-gray-500 dark:bg-input/30 aspect-square size-4 shrink-0 items-center justify-center rounded-full border shadow-sm shadow-black/5',
        Platform.select({
