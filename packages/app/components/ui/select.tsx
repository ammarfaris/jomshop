// NOTE: Does not work for web if we use inside a modal, also without modal for mobile web, need workaround (see example in RNR main page, change from preview to code)
...
import { ChevronUpOutline } from 'app/components/icons-svg/ChevronUpOutline'
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      {...props}
    >
      <Icon as={ChevronUpOutline} size={16} className="text-muted-foreground" />
    </SelectPrimitive.ScrollUpButton>
  )
}
